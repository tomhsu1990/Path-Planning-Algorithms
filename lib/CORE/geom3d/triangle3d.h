...
public:
  ...
  **/
  ...
  Point3d separation( const Segment3d& s ) const;
  double separationL( const Segment3d& s ) const;

  bool intersectionMultiHalfspace( Plane3d* H[], int H_n, double bound, Point3d mB );
